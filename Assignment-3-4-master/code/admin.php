...
<tr>
  ...
  <td><?php echo substr($row['date'],0,10) ?></td>
	<?php if($_SESSION['id'] != 1 && $row['author'] == "admin") {?>
		<td><a href="/index.php"><i class="fa fa-pencil-square-o fa-2x" aria-hidden="true"></i></a></td>
		<td><a href="/index.php"><i class="fa fa-times fa-2x" aria-hidden="true"></i></a></td>
<?php } else {?>
